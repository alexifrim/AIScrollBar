#
#  Be sure to run `pod spec lint AIScrollBar.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # spec.author             = { "alex ifrim" => "alexifrim@users.noreply.github.com" }
  spec.author    = "alex ifrim"
  # spec.authors            = { "alex ifrim" => "alexifrim@users.noreply.github.com" }
  # spec.social_media_url   = "https://twitter.com/alex ifrim"
